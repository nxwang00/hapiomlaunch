				...
				<div class="ui-block">
					...
					<article class="hentry post">
						...
						<div class="post__author author vcard inline-items">
							<img loading="lazy" src="{{ url('public/assets/dashboard/img/author-page.webp') }}" width="36" height="36" alt="author">
				...
				<nav aria-label="Page navigation">
					...
					<ul class="pagination justify-content-center">
						...
						<li class="page-item {{ ($friendlists->currentPage() == $friendlists->lastPage()) ? ' disabled' : '' }}">
							<a class="page-link" href="{{ $friendlists->url($results->lastPage()) }}">Next</a>
						</li>
					</ul>
					@endif
				</nav>
