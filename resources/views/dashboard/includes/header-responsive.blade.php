				...
				<ul class="notification-list friend-requests">
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="{{ url('public/assets/dashboard/img/avatar55-sm.webp') }}" alt="author" width="34" height="34">
						</div>
					...
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="{{ url('public/assets/dashboard/img/avatar56-sm.webp') }}" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
					...
					<li class="accepted">
						<div class="author-thumb">
							<img loading="lazy" src="{{ url('public/assets/dashboard/img/avatar57-sm.webp') }}" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
							You and
					...
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="{{ url('public/assets/dashboard/img/avatar58-sm.webp') }}" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
				...
				<ul class="notification-list">
					...
					<li class="with-comment-photo-wrap">
						<div class="with-comment-photo">
							<div class="author-thumb"><img loading="lazy" src="{{ url('public/assets/dashboard/img/avatar64-sm.webp') }}" width="34" height="34" alt="author"></div>
							<div class="notification-event">
						...
						<div class="comment-photo"><img loading="lazy" src="{{ url('public/assets/dashboard/img/comment-photo1.webp') }}" alt="photo" width="40" height="40">
