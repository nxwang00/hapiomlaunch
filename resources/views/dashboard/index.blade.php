				...
				<div class="ui-block-content">
					<div class="world-statistics">
						<div class="world-statistics-img">
							<img loading=lazy src="{{ url('public/assets/dashboard/img/world-map.webp') }}" alt="map" width="520" height="281">
						</div>

						<ul class="country-statistics">
							<li>
								<img loading=lazy src="{{ url('public/assets/dashboard/img/flag1.webp') }}" alt="flag" width="16" height="11">
								<span class="country">United States</span>
								<span class="count-stat">86.134</span>
							</li>
							<li>
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/flag2.webp') }}" alt="flag" width="16" height="11">
								<span class="country">Mexico</span>
								<span class="count-stat">35.136</span>
							</li>
							<li>
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/flag3.webp') }}" alt="flag" width="16" height="11">
								<span class="country">France</span>
								<span class="count-stat">12.600</span>
							</li>
							<li>
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/flag4.webp') }}" alt="flag" width="16" height="11">
								<span class="country">Spain</span>
								<span class="count-stat">9.471</span>
							</li>
							<li>
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/flag5.webp') }}" alt="flag" width="16" height="11">
								<span class="country">Ireland</span>
								<span class="count-stat">8.058</span>
							</li>
							<li>
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/flag6.webp') }}" alt="flag" width="16" height="11">
								<span class="country">Argentina</span>
								<span class="count-stat">5.653</span>
							</li>
							<li>
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/flag7.webp') }}" alt="flag" width="16" height="11">
