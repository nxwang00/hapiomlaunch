		...
		<div class="col col-xl-12 order-xl-2 col-lg-12 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
			...
			<div class="ui-block">
				<div class="ui-block-title">
					...
					<a href="{{ route('polls-create') }}" class="btn btn-primary btn-md-2 float-right">Add New Polls<div class="ripple-container"></div></a>
					...
					<table class="forums-table">
						...
						<tr>
							...
							<td class="description">
								<a href="#" class="h6 count">{{ $result->question }}</a>
							</td>
							<td class="posts">
							...
							<td class="freshness">
								<a href="{{ route('polls-edit',$result->id) }}" class="btn btn-sm bg-blue">Edit</a>
								<a href="javascript:void(0)" route="{{ route('polls-delete',$result->id) }}" id="{{$result->id}}" text="remove product" class="btn btn-sm btn-border-think btn-transparent c-grey delete">Delete<div class="ripple-container"></div></a>
								<a href="{{ route('polls-detail',$result->id) }}" class="btn btn-sm bg-blue">Details</a>
							</td>
						</tr>
						@endforeach
	                    @else
