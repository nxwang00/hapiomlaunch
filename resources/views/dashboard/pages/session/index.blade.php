		...
		<div class="col col-xl-12 order-xl-2 col-lg-12 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
			...
			<div class="ui-block">
				<div class="ui-block-title">
					<h6 class="title">Session</h6>
					<a href="{{ route('session-create') }}" class="btn btn-primary btn-md-2 float-right">Add New Session<div class="ripple-container"></div></a>
				...
				@include('dashboard.includes.alert')
					<table class="forums-table">
						...
						<tr>
							...
							<td class="topics">
								<a href="#" class="h6 count">{{ $result->session }}</a>
							</td>
							...
							<td class="description">
								...
								<img src="{{ url('public/images/session/'.$result->image) }}" style="max-width: 40px;">
 								@endif
							</td>
							<td class="posts">
							...
							<td class="freshness">
								<a href="{{ route('session-edit',$result->id) }}" class="btn btn-sm bg-blue">Edit</a>
								<a href="javascript:void(0)" route="{{ route('session-delete',$result->id) }}" id="{{$result->id}}" text="remove session" class="btn btn-sm btn-border-think btn-transparent c-grey delete">Delete<div class="ripple-container"></div></a>
							</td>
						</tr>
						@endforeach
	                    @else
...
<script type="text/javascript">
	$(document).on('click', '.delete', function() {
	    ...
	    if (!confirm("Are you sure? Do yo want to delete session.")){
	      return false;
	    }
	    $.ajax({
	        url: route,
