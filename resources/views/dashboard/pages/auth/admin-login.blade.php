			...
			<div class="registration-login-form">
				...
				<div class="tab-content" id="registration-form-tabs-content">
					...
					<div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
						<div class="title h6">Plan to Hapiom</div>
						<form class="content require-validation" method="POST" action="{{ route('stripe.post') }}" data-cc-on-file="false"  data-stripe-publishable-key="{{ env('STRIPE_KEY') }}">
                            {{ csrf_field() }}
							<div class="row">
								...
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<div class="form-group label-floating is-empty required">
									...
									<div class="form-group label-floating is-empty required">
										...
										<input class="form-control card-number" placeholder="" type="text" autocomplete="off">
									</div>

									<div class="form-group label-floating is-empty cvc required">
										<label class="control-label">CVC</label>
										<input class="form-control card-cvc" placeholder="ex. 311" type="text" size='4' autocomplete="off">
									</div>

									<div class="form-group label-floating is-empty expiration required">
									...
									<button type="submit" class="btn btn-purple btn-lg full-width">Pay Now!</button>
								</div>
							</div>
						</form>
					</div>
