...
@section('title', ' Free Details')
@section('page', ' Free Details')
...
<div class="stunning-header bg-primary-opacity">
	...
	<div class="stunning-header-content">
		<h1 class="stunning-header-title">Free Details</h1>
				...
				<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
					<div class="thumbs-wrap">
						<!-- <div class="small-thumbs-wrap js-zoom-gallery">
							<a href="{{ url('public/assets/dashboard/img/product-small1.webp') }}" class="small-thumb">
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/product-small1.webp') }}" width="61" height="50" alt="product">
							</a>
							<a href="{{ url('public/assets/dashboard/img/product-small2.webp') }}" class="small-thumb">
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/product-small2.webp') }}" width="80" height="56" alt="product">
							</a>
						</div> -->
	
						<div class="shop-product-detail-thumb">
							<img class="main-img" alt="product" src="{{ url('public/images/free/'.$free->image) }}" width="420" height="301">
						</div>
					</div>
				</div>
				<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
					<div class="shop-product-detail-content">
						<div class="main-content-wrap">
							<div class="block-title">
								...
								<h2 class="title bold">{{ $free->free }}</h2>
								<ul class="rait-stars">
									<li>
										<svg class="star-icon c-primary" width="10" height="10"><use xlink:href="#olymp-star-full"></use></svg>
									</li>
				...
				@if($frees->count() > 0)
					...
					<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
						...
						<div class="shop-product-item">
							<div class="product-thumb">
								<img loading="lazy" src="{{ url('public/images/free/'.$value->image) }}" alt="product" width="230" height="218">
							</div>
							<div class="product-content">
								<div class="block-title">
									<a href="#" class="product-category">COFFEE MUGS</a>
									<a href="#" class="h5 title">{{ $value->free }}</a>
								</div>
								<div class="block-price">
									<ul class="rait-stars">
										<li>
