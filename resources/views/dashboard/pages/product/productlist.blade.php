...
<div class="stunning-header bg-primary-opacity">
	...
	<div class="stunning-header-content">
		<h1 class="stunning-header-title">Products List</h1>
		...
		<div class="row">
			@if($results->count() > 0)
				...
				<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
					...
					<a href="{{ route('product-details',$result->id) }}">

						<!-- Product Item -->
						
						<div class="shop-product-item">
							<div class="product-thumb">
								<img loading="lazy" src="{{ url('public/images/product/'.$result->image) }}" alt="product" width="230" height="218">
							</div>
							<div class="product-content">
								<div class="block-title">
									<a href="#" class="product-category">COFFEE MUGS</a>
									<a href="#" class="h5 title">{{ $result->product }}</a>
								</div>
