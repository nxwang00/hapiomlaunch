		...
		<div class="col col-xl-12 order-xl-2 col-lg-12 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
			...
			<div class="ui-block">
				<div class="ui-block-title">
					<h6 class="title">Add New Course</h6>
					<a href="{{ route('course') }}" class="btn btn-primary btn-md-2 float-right">Back<div class="ripple-container"></div></a>
				</div>
				<div class="ui-block-content">
					@include('dashboard.includes.alert')
					<form class="needs-validation" method="post" action="{{ route('course-save') }}" enctype="multipart/form-data" novalidate >
						@csrf
						...
						<div class="row">
							<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
								<div class="form-group label-floating">
									...
									<input class="form-control" type="text" name="course" id="course" placeholder="" value="{{ old('course') }}" required>
