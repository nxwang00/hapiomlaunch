		...
		<div class="col col-xl-12 order-xl-2 col-lg-12 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
			<div class="ui-block">
				<div class="ui-block-title">
					<h6 class="title">Add New Membership Level</h6>
				...
				<div class="ui-block-content">
					...
					<form method="post" action="{{ route('mebership-save') }}">
						@csrf
						<div class="row">
							...
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group label-floating">
									...
									<input class="form-control" placeholder="" id="name" name="name" type="text" value="{{ old('name') }}">
								</div>
							</div>
							...
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group label-floating">
									...
									<input class="form-control" placeholder="" id="amount" name="amount" type="text" value="{{ old('amount') }}">
								</div>
							</div>
