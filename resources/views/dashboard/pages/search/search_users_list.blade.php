					...
					<div class="ui-block">
						...
						<div class="friend-item">
							<div class="friend-header-thumb">
								<img loading="lazy" src="{{ url('public/assets/dashboard/img/friend9.webp') }}" alt="friend" width="318" height="122">
							</div>
							...
							<div class="friend-item-content">
								...
								<div class="friend-avatar">
									<div class="author-thumb">
										<img loading="lazy" src="{{ url('public/assets/dashboard/img/avatar16.webp') }}" alt="author" width="92" height="92">
									</div>
