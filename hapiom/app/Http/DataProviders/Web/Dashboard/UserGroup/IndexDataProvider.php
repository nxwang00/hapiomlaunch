...
class IndexDataProvider
{
    ...
    {
        $data = Groupmaster::select('groupmasters.*')->join('group_master_admins','group_master_admins.groupmaster_id','=','groupmasters.id')->where('groupmasters.group_type', '1')->orderBy('id', 'ASC');
