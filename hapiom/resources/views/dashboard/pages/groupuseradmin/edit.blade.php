                     ...
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                         <p>@include('dashboard.includes.alert')</p>
                           <form method="post" action="{{ route('user.group.update',$groupmaster->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
							                 @csrf
                              <div class="row">
                                  <div class="form-group col-md-6">
                                     <label for="email">Name:</label>
                                     <input class="form-control" type="text" placeholder="Name" value="{{ $groupmaster->name }}" name="name" required="">
                                  </div>
                              ...
                              <div class="row">
                                  <div class="form-group col-md-6">
                                     ...
                                     <textarea class="form-control" name="terms_and_condition" rows="5">{{ @$groupmaster->terms_and_condition }}</textarea>
                                  </div>
                              </div>
