				...
				<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
					<div class="thumbs-wrap">
						...
						<div class="shop-product-detail-thumb">
							<img class="main-img" alt="product" src="{{ url('images/free/'.$free->image) }}" width="420" height="301">
						</div>
					</div>
				</div>
				<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				...
				@if($frees->count() > 0)
					...
					<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
						...
						<div class="shop-product-item">
							<div class="product-thumb">
								<img loading="lazy" src="{{ url('images/free/'.$value->image) }}" alt="product" width="230" height="218">
							</div>
							<div class="product-content">
								<div class="block-title">
									<a href="#" class="product-category">COFFEE MUGS</a>
