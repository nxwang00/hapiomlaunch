                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Add member Invite People to collaborate on "HapiOm Home Page"</h4>
                        </div>
                        <a href="{{ route('newsfeed') }}" class="btn-sm btn-primary btn-md-2 float-right">Back<div class="ripple-container"></div></a>
                    </div>
                    @include('dashboard.includes.alert')
                    <div class="iq-card-body">
                        <div class="acc-edit">
                            <form method="post" action="{{ route('process') }}" class="needs-validation frmInviteUser" id="frmInviteUser">
                                @csrf
