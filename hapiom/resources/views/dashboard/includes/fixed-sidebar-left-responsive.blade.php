<div class="fixed-sidebar left fixed-sidebar-responsive">
	...
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left-responsive">
		<a href="{{ route('dashboard') }}" class="logo js-sidebar-open">
			<img loading="lazy" src="{{ url('assets/dashboard/img/logo.webp') }}" alt="Hapiom" width="34" height="34">
		</a>
			...
			<div class="control-block">
				<div class="author-page author vcard inline-items">
					<div class="author-thumb">
						<img alt="author" src="{{ url('assets/dashboard/img/author-page.webp') }}" width="36" height="36" class="avatar">
