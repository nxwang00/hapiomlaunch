...
<head>
	...
	<!-- Theme Font -->
		<link rel="stylesheet" type="text/css" href="{{ url('assets/dashboard/css/theme-font.min.css') }}" as="style">

	<!-- Bootstrap CSS -->
	<link rel="stylesheet" type="text/css" href="{{ url('assets/dashboard/Bootstrap/dist/css/bootstrap.css') }}">
...
<div class="fixed-sidebar left fixed-sidebar-responsive">
	...
	<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1-responsive">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			...
			<div class="ui-block-title ui-block-title-small">
				<h6 class="title">About Hapiom</h6>
			</div>

			<ul class="about-Hapiom">
				<li>
					<a href="#">
...
<script src="{{ url('assets/dashboard/Bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
