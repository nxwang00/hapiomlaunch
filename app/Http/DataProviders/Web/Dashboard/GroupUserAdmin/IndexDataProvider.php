...
namespace App\Http\DataProviders\Web\Dashboard\GroupUserAdmin;
...
class IndexDataProvider
{
    ...
    {
        $data = Groupmaster::select('groupmasters.*')->join('group_master_admins','group_master_admins.groupmaster_id','=','groupmasters.id')->where('group_master_admins.user_id',Auth::user()->id)->orderBy('id', 'ASC');
